...
install -m 644 files/seeed-voicecard-dkms_0.3+git20190227-1_all.deb "${ROOTFS_DIR}/var/cache/apt/archives"
...
dpkg --install /var/cache/apt/archives/seeed-voicecard-dkms_0.3+git20190227-1_all.deb
EOF
